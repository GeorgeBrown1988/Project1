...
bool __cdecl CMsgTriggerService::StartService()
{
	...
	//设置队列
	if (m_RequestQueueService.SetDataQueueServiceSink((IDataQueueServiceSink*)this)==false)
	{
		#ifdef _DEBUG
...
//获取接口
void * __cdecl CMsgTriggerService::GetMsgTriggerQueueService()
{
	return (void*)&m_RequestQueueService;
}
