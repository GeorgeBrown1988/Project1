...
interface IDataBaseService : public CObject
{
	...
	//获取接口
	virtual void * __cdecl GetQueueService()=NULL;
};
...
public:
	...
	//获取接口
	virtual void * __cdecl GetMsgTriggerQueueService()=NULL;
};
...
public:
	...
	virtual bool __cdecl SetMsgTriggerServiceSink(CObject * pIObject)=NULL;
	//设置网络引擎接口
	virtual bool __cdecl InitKernelService(WORD wListenPort, WORD wMaxSocketItem)=NULL;

	//服务查询
public:
	//获取数据库引擎接口
	virtual void * __cdecl GetDataBaseService()=NULL;
	//获取调度引擎接口
	virtual void * __cdecl GetMsgTriggerService()=NULL;
	//获取网络引擎接口
	virtual void * __cdecl GetTCPSocketService()=NULL;
	//获取接口
	virtual void * __cdecl GetDataBaseQueueService()=NULL;
	//获取接口
	virtual void * __cdecl GetMsgTriggerQueueService()=NULL;
