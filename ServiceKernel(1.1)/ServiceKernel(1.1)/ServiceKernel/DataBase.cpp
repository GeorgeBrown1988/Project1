...
{
	m_ConnectInfo.m_szDataBase=szDB;
	m_ConnectInfo.m_szDataBaseIP=szIP;
	m_ConnectInfo.m_szPassWord=szPass;
	m_ConnectInfo.m_szUserName=szUser;
...
void CDBError::ShowErrorMsg()
{
	...
	CString szMsg;
	szMsg.Format("%s",m_pDB->GetErrorInfo());
#ifdef _DEBUG
...
//获取接口
void * __cdecl CDataBaseService::GetQueueService()
{
